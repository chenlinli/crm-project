...
<s:form id="form1" name="form1"
		action="saleVisit_save" method="post" theme="simple">
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>拜访时间：</td>
								<td>
								<s:textfield readonly="true" id="visit_time" cssClass="textbox"
														cssStyle="WIDTH: 180px" maxLength="50" name="visit_time"></s:textfield>
								</td>
								<td>拜访地点 ：</td>
								<td>
							...
							<TR>
								...
								<td>下次拜访时间 ：</td>
								<td>
							<s:textfield readonly="true" cssClass="textbox" id="visit_nexttime"
